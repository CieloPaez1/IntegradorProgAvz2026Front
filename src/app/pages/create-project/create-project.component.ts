...
import { LucideCheckCircle, LucideXCircle, LucideSave, LucideX } from '@lucide/angular';

@Component({
  selector: 'app-create-project',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, LucideCheckCircle, LucideXCircle, LucideSave, LucideX],
