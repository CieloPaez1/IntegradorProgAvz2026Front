...
import { LucideFolderKanban, LucideCheckCircle, LucideXCircle, LucideSave } from '@lucide/angular';

@Component({
  selector: 'app-create-project',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, LucideFolderKanban, LucideCheckCircle, LucideXCircle, LucideSave],
